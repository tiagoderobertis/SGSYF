...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-07-2024 a las 17:48:37
...
CREATE TABLE `configuracion` (
  ...
  `nombre_empresa` char(150) DEFAULT NULL,
...
INSERT INTO `configuracion` (`id_config`, `nombre_empresa`, `logo`) VALUES
(1, 'NombreDeTuEmpresa', NULL);
...
(1, 'f', 'f', 'papin', 'papas lays', 3, 'f', 3, 100),
(2, 'mayonesas', 's', 'mayonesa', 'hellmans', 1000, 'kilo', 200, 20);
...
(2, 'Admin', 'joaco123', 'SoloYoPuedo', 'Administrador'),
(3, 'JoacoModoUsuario', 'aaaaa', NULL, 'Usuario'),
(4, 'aaaaaa', 'aaa', NULL, 'Usuario'),
(5, 'achange', 'aaaa', NULL, 'Usuario'),
(6, 'a', 'a', NULL, 'Usuario'),
(7, 'a', 'a', NULL, 'Usuario');
